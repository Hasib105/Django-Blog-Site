...
from App_login.forms import SignUpForm , UserPorfileChange , ProfilePic
...
def user_change(request):
    ...
    form = UserPorfileChange(instance= current_user)
    if request.method == 'POST':
        form = UserPorfileChange(request.POST, instance= current_user)
        if form.is_valid():
            form.save()
            form = UserPorfileChange(instance = current_user)
